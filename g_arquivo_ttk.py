from tkinter import ttk, StringVar, X, BOTH, RIGHT, LEFT, Y, END, W, Menu, E, Toplevel, messagebox
import os
import shutil
...
class App(ThemedTk):
    ...
    def loader_main_frame(self):
        ...
        #Frames
        self.f_main = ttk.Frame(self)
        self.f_browser = ttk.Frame(self.f_main, height=50)
        self.f_browser_files=ttk.Frame(self.f_main)
        self.f_info = ttk.Frame(self.f_browser, height=30)
        self.f_search = ttk.Frame(self.f_browser, height=20)
        self.f_current_path = ttk.Frame(self.f_search, height=20)
        ...
        #Scrollbar
        self.scrollbar = ttk.Scrollbar(self.f_browser_files, orient='vertical', command=self.tview_files.yview)
    ...
    def loader_info_widgets(self):
        ...
        if list(os.uname())[0] == 'Linux':
            ...
            ttk.Button(self.f_info, text=source, command= lambda : self.loader_file_disc(source)).pack(side=LEFT, padx=10, pady=10)
    ...
    def loader_current_path(self):
        ...
        ttk.Label(self.f_current_path, text=self.current_path).pack(anchor=W, side=LEFT)
        self.f_current_path.menubutton_1 = ttk.Menubutton(self.f_current_path, text='...')
        self.f_current_path.menubutton_1.menu = Menu(self.f_current_path.menubutton_1, tearoff=0)
    ...
    def loader_search_widgets(self):
        ...
        self.search = ttk.Entry(self.f_search, font=('Roboto Slab', 15))
        self.search.pack(side=LEFT, fill=X, expand=True, padx=10, pady=10)
        ttk.Button(self.f_search, text='', image=self.icon_search, command=self.search_file).pack(side=RIGHT, padx=10, pady=10)
